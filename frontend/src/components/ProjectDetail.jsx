			...
			<div className="flex flex-col gap-5">
				...
				<div className="flex flex-col justify-between">
					...
					<div className="flex gap-5 align-middle text-white ">
						<div className="pr-3 border-r-2">
							<h2 className="text-baseGreen text-xl">
								Tech Stack
							</h2>
						...
						<div className="pr-3">
							...
							<h1 className="">
								{projectDetail.type_of_collaborator}
							</h1>
						</div>
					</div>
				</div>
				<div className="flex flex-col gap-1">
					...
					<h1 className="">
						...
						Ipsa suscipit dolorum tenetur labore sed aperiam porro.
						Vero, officiis! Debitis voluptates blanditiis, atque
						deleniti veniam excepturi modi sequi! Repellendus
						dolorum non voluptas, aliquid a id eligendi.
					</h1>
				</div>
				<div className="flex flex-col gap-1">
				...
				<div className="flex flex-col gap-1">
					...
					<h1 className="text-blue-500 underline">
						<a href={projectDetail.github_link}>
