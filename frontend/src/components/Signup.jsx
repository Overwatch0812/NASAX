...
const Signup = () => {
  ...
  const onSubmit = (e) => {
    ...
    dispatch(signup(userData)).then(e=>{console.log(e);})
    console.log(email,
      password,
      re_password,
      full_name,
  ...
  return (
    <>
      ...
      <form onSubmit={(e) => onSubmit(e)}>
        ...
        <Select
          value={preferred_language.value}          options={preferred_language}
        ...
        <Select
          ...
          onChange={(e) =>
            setLevel_Of_Understanding_Of_Preferred_Languagez(e.value)
          }
          options={level_of_understanding_of_preferred_language}
          defaultValue={level_of_understanding_of_preferred_language[0]}
        />
